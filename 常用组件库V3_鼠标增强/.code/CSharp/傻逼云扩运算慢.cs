...
{
    //在这里编写您的代码
    midpoint = totalDistance*4/5; // 加速度切换点
    ...
    while( currentDistance < totalDistance) { 
        ...
        velocity0 = velocity; // 当前循环初始速度=当前速度
		
        velocity = velocity0+currentAcceleration*time; // 计算本次位移速度
    ...
    Console.WriteLine("final currentDistance="+currentDistance);
    Console.WriteLine("tracksList.Sum()="+tracksList.Sum());
